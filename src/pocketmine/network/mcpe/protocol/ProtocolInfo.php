...
final class ProtocolInfo implements PacketMagicNumbers{
    ...
    public const PROTOCOL_818 = 818; // 1.21.90, 1.21.91, 1.21.92, 1.21.93
    public const PROTOCOL_824 = 824; // 1.21.100, 1.21.101, 1.21.102, 1.21.103
    /**
	 * Current Minecraft PE version reported by the server. This is usually the earliest currently supported version.
	 */
	public const MINECRAFT_VERSION = '0.15.0 - 1.21.100';
	/**
